    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; font-family: 'Segoe UI', system-ui, sans-serif; transition: all 0.3s ease; }
        ...
        .notif-dropdown { position: absolute; top: 55px; right: 0; width: 310px; max-width: 90vw; background: var(--card-bg); border: 1px solid var(--accent-gold); border-radius: 15px; padding: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.8); z-index: 999; display: none; }
